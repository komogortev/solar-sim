...
class FirstPersonCamera {
  ...
  updateCamera_(_) {
    ...
    const ray = new Ray(this.translation_, dir);
  ...
  updateTranslation_(timeElapsedS) {
    const forwardVelocity = (this.input_.key(this.KEYS.w) ? 1 : 0) + (this.input_.key(this.KEYS.s) ? -1 : 0)
    const strafeVelocity = (this.input_.key(this.KEYS.a) ? 1 : 0) + (this.input_.key(this.KEYS.d) ? -1 : 0)
